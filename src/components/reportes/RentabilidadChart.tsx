        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 h-full flex flex-col justify-between">
            ...
            <div className="relative flex-1 min-h-[250px] w-full">
                ...
                <div className="absolute inset-0 overflow-x-auto overflow-y-hidden">
                    <div className="h-full min-w-full flex items-end justify-start md:justify-center gap-3 md:gap-6 px-2 md:px-4 pb-1">
                        {chartData.map((item, index) => {
                            ...
                            return (
                                <div key={item.fecha} className="flex-1 flex flex-col items-center justify-end h-full group/bar min-w-[80px] max-w-[120px]">
                                    {/* Labels always visible */}
                                    <div className="mb-1 text-[10px] font-bold text-gray-600 w-full text-center truncate px-1">
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                {(item.ganancia / maxVal * 100) > 15 && (
                                                    <span className="text-[9px] font-bold text-white mb-1 drop-shadow-sm px-0.5 truncate max-w-full">
                                            ...
                                            {/* Tooltip */}
                                            <div className="opacity-0 group-hover/bar:opacity-100 absolute bottom-full left-1/2 -translate-x-1/2 mb-2 bg-gray-900 text-white text-xs p-2 rounded shadow-lg z-20 w-max transition-opacity duration-200 pointer-events-none">
